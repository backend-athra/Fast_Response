...
trackingDistanceStatus: {
  type: String,
  enum: ["normal","warning","alert","abandoned"],
  default: "normal"
},
arrivedAt: {
  type: Date
   ...
   issues: [
  {
    issueType: {
      type: String,
      enum: ["need_parts", "need_specialist", "customer_unavailable", "other","cannot_reach_location"],
    },
    remarks: String,
